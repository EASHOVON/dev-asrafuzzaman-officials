        ...
        <div className="left">
          ...
          <div className="about__info">
            <PText>
              ...
              always try to design and development stuff with my unique point of
              view. I also love to create things that can be useful to others.
              <br /> <br />
              I started coding since I was in collage. Coding is also an art for
              me. I love it and now I have the opportunity to design along with
              the coding. I find it reality interesting and I enjoyed the
              process a lot. <br />
              <br />
